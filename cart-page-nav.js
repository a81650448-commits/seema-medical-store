// Global cart button - uses the SAME cart storage as cart-fix.js.
(function(){
  'use strict';
  ...
  function update(){
    ...
    const e=document.getElementById('globalCartCount');if(e)e.textContent=count;
    const main=document.getElementById('cartCount');if(main)main.textContent=count;
  }
  function add(){
    if(/admin\.html$/i.test(location.pathname)||document.getElementById('globalCartButton'))return;
    const b=document.createElement('a');b.id='globalCartButton';b.href='index.html#cart';
