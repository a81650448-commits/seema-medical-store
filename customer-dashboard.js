...
(function () {
  ...
  function buildDashboard() {
    ...
    style.textContent = `
      ...
      .customer-dashboard-overlay{position:fixed;inset:0;background:rgba(4,20,14,.48);z-index:50;opacity:0;visibility:hidden;transition:.2s ease}.customer-dashboard-overlay.open{opacity:1;visibility:visible}
