...
(function () {
  ...
  function buildDashboard() {
    ...
    style.textContent = `
      ...
      .customer-dashboard-trigger{position:fixed;left:0;top:105px;z-index:9999;border:0;background:#087443;color:#fff;padding:13px 10px;border-radius:0 12px 12px 0;font-weight:800;cursor:pointer;box-shadow:0 8px 24px rgba(0,0,0,.18);writing-mode:vertical-rl;transform:rotate(180deg)}
      ...
      @media(max-width:520px){.customer-dashboard-trigger{top:105px;padding:11px 8px;font-size:12px}.customer-dashboard-drawer{width:86vw}}
    `;
