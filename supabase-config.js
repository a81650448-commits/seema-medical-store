// Aditya Medical Store - Supabase connection
window.SUPABASE_URL = "https://fdqgknsevrvejptxeiyn.supabase.co";
window.SUPABASE_ANON_KEY = "sb_publishable_NQowbn8VOx4cARVy2tIpNA_p1FvY4Nb";

// Billing: keep the original billing module for the customer site, but use the GST billing module on Admin Panel.
(function(){const isAdmin=/admin\.html$/i.test(window.location.pathname);const s=document.createElement('script');s.src=(isAdmin?'billing-gst.js?v=20260823-05':'billing.js?v=20260821-03');s.defer=true;document.head.appendChild(s);})();
...
(function(){if(!/admin\.html$/i.test(window.location.pathname))return;const s=document.createElement('script');s.src='admin-gst-bridge.js?v=20260823-01';s.defer=true;document.head.appendChild(s);})();
