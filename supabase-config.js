...
// Billing: keep the original billing module for the customer site, but use the
// GST billing module exclusively on the Admin Panel so the old 4-column printer
// cannot override the Aditya GST invoice.
(function(){const isAdmin=/admin\.html$/i.test(window.location.pathname);const s=document.createElement('script');s.src=(isAdmin?'billing-gst.js?v=20260823-04':'billing.js?v=20260821-03');s.defer=true;document.head.appendChild(s);})();
