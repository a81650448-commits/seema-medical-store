...
(function(){if(!/admin\.html$/i.test(window.location.pathname))return;const s=document.createElement('script');s.src='gst-billing-force.js?v=20260823-03';s.defer=true;document.head.appendChild(s);})();
